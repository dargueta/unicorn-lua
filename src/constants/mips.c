...
const struct NamedIntConst kMIPSConstants[] = {
    ...
    {"UC_MIPS_REG_ENDING", UC_MIPS_REG_ENDING},
    {"UC_MIPS_REG_ZERO", UC_MIPS_REG_ZERO},
    {"UC_MIPS_REG_AT", UC_MIPS_REG_AT},
    {"UC_MIPS_REG_V0", UC_MIPS_REG_V0},
    {"UC_MIPS_REG_V1", UC_MIPS_REG_V1},
    {"UC_MIPS_REG_A0", UC_MIPS_REG_A0},
    {"UC_MIPS_REG_A1", UC_MIPS_REG_A1},
    {"UC_MIPS_REG_A2", UC_MIPS_REG_A2},
    {"UC_MIPS_REG_A3", UC_MIPS_REG_A3},
    {"UC_MIPS_REG_T0", UC_MIPS_REG_T0},
    {"UC_MIPS_REG_T1", UC_MIPS_REG_T1},
    {"UC_MIPS_REG_T2", UC_MIPS_REG_T2},
    {"UC_MIPS_REG_T3", UC_MIPS_REG_T3},
    {"UC_MIPS_REG_T4", UC_MIPS_REG_T4},
    {"UC_MIPS_REG_T5", UC_MIPS_REG_T5},
    {"UC_MIPS_REG_T6", UC_MIPS_REG_T6},
    {"UC_MIPS_REG_T7", UC_MIPS_REG_T7},
    {"UC_MIPS_REG_S0", UC_MIPS_REG_S0},
    {"UC_MIPS_REG_S1", UC_MIPS_REG_S1},
    {"UC_MIPS_REG_S2", UC_MIPS_REG_S2},
    {"UC_MIPS_REG_S3", UC_MIPS_REG_S3},
    {"UC_MIPS_REG_S4", UC_MIPS_REG_S4},
    {"UC_MIPS_REG_S5", UC_MIPS_REG_S5},
    {"UC_MIPS_REG_S6", UC_MIPS_REG_S6},
    {"UC_MIPS_REG_S7", UC_MIPS_REG_S7},
    {"UC_MIPS_REG_T8", UC_MIPS_REG_T8},
    {"UC_MIPS_REG_T9", UC_MIPS_REG_T9},
    {"UC_MIPS_REG_K0", UC_MIPS_REG_K0},
    {"UC_MIPS_REG_K1", UC_MIPS_REG_K1},
    {"UC_MIPS_REG_GP", UC_MIPS_REG_GP},
    {"UC_MIPS_REG_SP", UC_MIPS_REG_SP},
    {"UC_MIPS_REG_FP", UC_MIPS_REG_FP},
    {"UC_MIPS_REG_S8", UC_MIPS_REG_S8},
    {"UC_MIPS_REG_RA", UC_MIPS_REG_RA},
    {"UC_MIPS_REG_HI0", UC_MIPS_REG_HI0},
    {"UC_MIPS_REG_HI1", UC_MIPS_REG_HI1},
    {"UC_MIPS_REG_HI2", UC_MIPS_REG_HI2},
    {"UC_MIPS_REG_HI3", UC_MIPS_REG_HI3},
    {"UC_MIPS_REG_LO0", UC_MIPS_REG_LO0},
    {"UC_MIPS_REG_LO1", UC_MIPS_REG_LO1},
    {"UC_MIPS_REG_LO2", UC_MIPS_REG_LO2},
    {"UC_MIPS_REG_LO3", UC_MIPS_REG_LO3},
