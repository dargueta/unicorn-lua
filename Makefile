...
ALL_AUTOGENERATED_FILES = $(AUTOGENERATED_C_FILES) $(AUTOGENERATED_H_FILES) $(AUTOGENERATED_LUA_FILES)
...
.PHONY: docs
docs: $(ALL_AUTOGENERATED_FILES) $(LDOC_FILES) $(LUA_SOURCE_DIR)/registers_const.lua
	ldoc .
...
.PHONY: autogen-files
autogen-files: $(ALL_AUTOGENERATED_FILES)
