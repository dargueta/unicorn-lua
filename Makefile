...
# Because Unicorn can be customied to exclude architectures, not all of these may be
...
LIB_C_SOURCES = \
    $(addprefix $(SOURCE_DIR)/,control_functions.c engine.c unicorn.c) \
...
__test: $(TEST_LUA_SOURCES) | $(BUSTED)
	$(BUSTED) $(BUSTED_FLAGS) --lua=$(LUA) --shuffle --pattern lua tests/lua
