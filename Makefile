...
DEBUG_CFLAGS=-Wall -Wextra -Wpedantic -Werror -pedantic -pedantic-errors \
    -Wstrict-prototypes -Wdeprecated -Wformat=2 -Wformat-signedness \
    -Wuse-after-free=3 -Wuseless-cast -O0 -ggdb -g3 -std=c99
DEBUG_LDFLAGS=
...
$(LUA_SOURCE_DIR)/%_extracted_consts.txt: tools/process_header.lua
