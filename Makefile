...
CPP_TEMPLATE_SOURCES := src/registers_const.tpl src/registers.tpl
AUTOGENERATED_CPP_FILES = $(CPP_TEMPLATE_SOURCES:.tpl=.cpp)
...
clean:
	...
	$(RM) -r $(BUILD_DIR) $(CONSTS_DIR) $(AUTOGENERATED_CPP_FILES)
...
src/registers_const.cpp: src/registers_const.tpl src/register_types.lua
	$(LUA) tools/render_template.lua -o $@ $^

src/registers.cpp: src/registers.tpl src/register_types.lua
	$(LUA) tools/render_template.lua -o $@ $^
